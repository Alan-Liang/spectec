...
%token SYNTAX GCONTEXT GRAMMAR RELATION RULE VAR DEF
...
def_ :
  ...
  | GCONTEXT varid_bind LBRACK typ RBRACK COLON typ hint*
    { GContextFamD ($2, [], $4, $7, $8) }
  | GCONTEXT varid_bind_lparen enter_scope comma_list(arg) RPAREN LBRACK typ RBRACK COLON typ hint* exit_scope
    { GContextFamD ($2, List.map El.Convert.param_of_arg $4, $7, $10, $11) }
  | GCONTEXT varid_bind LBRACK typ RBRACK COLON typ hint* EQ deftyp
    { GContextD ($2, [], $4, $7, $10, $8) }
  | GCONTEXT varid_bind_lparen enter_scope comma_list(arg) RPAREN LBRACK typ RBRACK COLON typ hint* EQ deftyp exit_scope
    { GContextD ($2, $4, $7, $10, $13, $11) }
