...
and t_ele env x k = ternary t_exp (t_list' t_exp) t_exp env x k
...
and t_exp' env e : bind list * exp' =
  ...
  | CtxSubstE (exp1, exp2s, exp3) -> t_ele env (exp1, exp2s, exp3) (fun (e1', e2', e3') -> CtxSubstE (e1', e2', e3'))
